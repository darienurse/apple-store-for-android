...
/**
 * A basic sample which shows how to use {@link com.itunesstoreviewer.app.SlidingTabs.SlidingTabLayout}
...
public class SlidingTabsColorsFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
         ...
         */
        for (int tabIndex = 0; tabIndex < ItunesAppController.getCategoryList().size() - 1; tabIndex++) {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        AdRequest adRequest = new AdRequest.Builder().addTestDevice("C59B5FEF4B6A21FC004560D138FA25B4").build();
     ...
     * are instances of {@link com.itunesstoreviewer.app.ItunesItemListFragment} which just display three lines of text. Each page is
